    ...
    let chatMessages = [
        ...
        [
            ChatMessage(text: """
                    ...
                    """, isIncoming: true),
            ChatMessage(text: "В этом наша разница, так сказать.", isIncoming: true)
        ],
        [
            ChatMessage(text: """
                    ...
                    """, isIncoming: false),
            ChatMessage(text: "Поэтому давай ступай, езжай, а я пошел наслаждаться, нахуй, блять, прекрасным осенним закатом, блять, на берегу теплой южной реки. Все, пиздуй-борозду и я попиздил нахуй.", isIncoming: true)
        ]
    ]
